...
# Node.js Osvědčené Postupy

<h1 align="center">
  <img src="assets/images/banner-2.jpg" alt="Node.js Osvědčené Postupy">
</h1>
...
Read in a different language: [![CN](/assets/flags/CN.png)**CN**](/README.chinese.md), [![BR](/assets/flags/BR.png)**BR**](/README.brazilian-portuguese.md), [![RU](/assets/flags/RU.png)**RU**](/README.russian.md) [(![ES](/assets/flags/ES.png)**ES**, ![FR](/assets/flags/FR.png)**FR**, ![HE](/assets/flags/HE.png)**HE**, ![KR](/assets/flags/KR.png)**KR**,[CZ](/assets/flags/CS.png)**CZ** ve výstavbě!)](#translations) and ![TR](/assets/flags/TR.png)**TR** ve výstavbě!)](#translations)

<br/>

###### Vytvořeno a udržováno naším [řídícím výborem](#steering-committee) a [kolaboranty](#collaborators)

# Nejnovější Osvědčené Postupy a novinky

- **✅ Nový osvědčený postup:** 7.1: [Don't block the event loop](#7-draft-performance-best-practices) by Keith Holliday
